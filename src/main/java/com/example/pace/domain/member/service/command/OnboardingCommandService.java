...
import com.example.pace.domain.member.exception.code.OnboardingErrorCode;
...
public class OnboardingCommandService {
    ...
    public OnboardingResDTO upsertOnboarding(Long memberId, OnboardingReqDTO request) {
        ...
        Setting setting = settingCommandService.getOrCreateSetting(member);
        ...
        for (AlarmType type : REQUIRED_TYPES) {
            ...
            settingCommandService.replaceReminderTimesFromMinutes(setting, type, minutes);
        }
