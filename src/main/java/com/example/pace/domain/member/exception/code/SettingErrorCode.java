...
public enum SettingErrorCode implements BaseErrorCode {
    ...
    MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "SETTING404_1", "멤버 정보를 찾을 수 없습니다"),
    SETTING_NOT_FOUND(HttpStatus.NOT_FOUND, "SETTING404_2", "설정 정보를 찾을 수 없습니다."),
    UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "SETTING401_3", "인증이 필요합니다."),
